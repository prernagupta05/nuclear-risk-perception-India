...
# 3) lm with kahan 
TM2_kahan <- lm(Risky_Nuclear ~ Uppercaste + Male + Hindu + Urban + age  + Communitarianism_score + Egalitarianism_score, data = TM2)

summary(TM2_kahan)

# 4) lm with ecopolvars 
TM2_allscales <- lm(Risky_Nuclear ~ Uppercaste + Male + Hindu + Urban + age + Pdevelop + Ndevelop + Communitarianism_score + Egalitarianism_score , data = TM2)
