...
ggplot(combined_data, aes(x = MR1, color = Dataset)) +
  ...
  labs(title = "Density Plot of MR1 for Each Dataset", x = "MR1 Value", y = "Density") +
  scale_color_manual(values = c("fct_scores" = "blue", "orgscores" = "red")) +
  theme_minimal()
...
ggplot(compare2, aes(x = Dataset, y = MR1, fill = Dataset)) +
  geom_boxplot() +
  geom_jitter(width = 0.2, aes(color = Dataset), size = 1.5, alpha = 0.5) +
  labs(title = "Boxplot of Pdevelop for Each Dataset", x = "", y = "MR1 Value") +
  scale_fill_manual(values = c("imputed" = "blue", "original" = "red")) +
...
ggplot(compare2, aes(x = Dataset, y = MR2, fill = Dataset)) +
  geom_boxplot() +
  geom_jitter(width = 0.2, aes(color = Dataset), size = 1.5, alpha = 0.5) +
  labs(title = "Boxplot of Ndevelop for Each Dataset with Points", x = "", y = "MR2 Value") +
  scale_fill_manual(values = c("imputed" = "blue", "original" = "red")) +
  scale_color_manual(values = c("imputed" = "blue", "original" = "red")) +
  theme_minimal()
...
kahannuclear <- fct_scores%>%
  rename(Communitarian_Egalitarian = MR1, Hierarchy = MR2)

nuclearformice <- cbind(formice, kahannuclear, ecopolnuclear) %>%
