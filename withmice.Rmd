...
sparams1$Scale <- NA
sparams1$Scale[1:5] <- "People Centered Development"
sparams1$Scale[6:10] <- "Nationalist Development"
...
ecopolc_2fa <- '
  Ndevelop =~ PRIDECOAL + NPRIDECOAL + DEVOVERENV +  DECISIONCEN + OWNERPVT + DECISIONCEN  + OWNERNOREG + DEVCOAL +PROSPERCOAL
  Pdevelop =~ BEAUTYCOAL + POLLUTECOAL + HEALTHCOAL + OWNERPUB + ENVOVERDEV + DISPLACECOAL
...
cNdevelop_alpha <- psych::alpha(cNdevelop, check.keys = TRUE) # alpha = 0.62
