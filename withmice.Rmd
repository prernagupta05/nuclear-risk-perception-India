...
# EFA with mifamiecopols$cov_combined

ecopolfits <- psych::fa(miecopols$cov_combined, nfactors = 3, rotate = "varimax")
...
ecopols_2fa <- '
  ...
  Pdevelop =~ HEALTHSOLAR + BEAUTYSOLAR + DISPLACESOLAR + POLLUTESOLAR 
'
...
ecopolfitc <- psych::fa(miecopolc$cov_combined, nfactors = 2, rotate = "varimax")
...
#+ DECISIONCEN + MECHANISATION + DEVOVERENV+ JOBSCOAL 
# + ENVOVERDEV + OWNERPUB

## CFA on ecopol vars for coal 

ecopolc_2fa <- '
  Ndevelop =~ NPRIDECOAL + PRIDECOAL + DEVOVERENV + DEVCOAL
  Pdevelop1 =~ BEAUTYCOAL + HEALTHCOAL + POLLUTECOAL 
...
cparams1$Scale <- NA
cparams1$Scale[1:5] <- "Nationalist Development"
cparams1$Scale[6:14] <- "People Centered Development (1)"
cparams1$Scale[9:14] <- "People Centered Development (2)"
